...
| I38 | 🟡 Medium | **Move Savatar1001/Claude repo to OrgSavatar** | Claude memory repo currently lives under personal `Savatar1001` account. Transfer to `OrgSavatar` org for consistency with all other repos. | — | Added 2026-04-02. |
